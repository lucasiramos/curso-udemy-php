            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" enctype="multipart/form-data" action="{{ route('user.update') }}" aria-label="Configuración de mi cuenta">
                        ...
                        <div class="form-group row">
                            <label for="nick" class="col-md-4 col-form-label text-md-right">Nickname</label>

                            <div class="col-md-6">
                                <input id="nick" type="text" class="form-control{{ $errors->has('nick') ? ' is-invalid' : '' }}" name="nick" value="{{ $errors->has('nick') ? old('nick') : Auth::user()->nick }}" required autofocus>
                        ...
                        @if(Auth::user()->image)
                            <div class="form-group row">
                                ...
                                <label for="image_path" class="col-md-4 col-form-label text-md-right">Avatar actual</label>
